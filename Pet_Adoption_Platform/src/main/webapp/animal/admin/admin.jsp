        ...
        <ul class="nav navbar-top-links navbar-right">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu dropdown-user ">
                    ...
                    <li><a href="${pageContext.request.contextPath}/admin/developing"><i class="fa fa-gear fa-fw"></i>
                        系统设置</a></li>
                    <li class="divider"></li>
                    <li>
            ...
            <div class="modal-body">
                <form class="form-horizontal" id="edit_admin_form" method="post" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="edit_adminName" placeholder="管理员账号"
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="edit_password" placeholder="用户密码"
                                   value="${admin.adminPwd}" name="adminPwd">
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="edit_Name" placeholder="真实名字"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="edit_telephone" placeholder="电话"
                                   value="${admin.telephone}" name="telephone">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-4">
                            <input type="date" class="form-control" id="edit_birthday" placeholder="生日"
                                   value="${admin.birthday}" name="birthday">
                        </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <textarea class="form-control" id="edit_remark" placeholder="个人介绍" value="${admin.remark}"
...
<script type="text/javascript">
    ...
    function build_admins_table(result) {
        ...
        $.each(admins, function (index, admin) {
            ...
            var picTd = $("<td></td>").append($("<img/>").addClass("adminHead").attr("src", "/pic/" + spilt(admin.pic)));
    ...
    $(document).on("click", ".edit_btn", function () {
        ...
        $.ajax({
            ...
            success: function (result) {
                ...
                $("#edit_pic").attr("src", "/pic/" + result.extend.admin.pic);
