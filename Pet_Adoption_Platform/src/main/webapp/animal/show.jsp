    ...
    <div>
        ...
        <div class="my_btn">
            ...
            <button class="btn btn-primary btn-lg" id="tianchuan_btn"
                    style=" position: relative; left: 150px;bottom: 45px">
                返回领养中心
            </button>
        </div>
    </div>
...
<script>
    ...
    function submit(result) {
        ...
        $.each(comments, function (index, comment) {
            var headTd = $("<header></header>").append($("<img>").attr("src", "/pic/" + (comment.user.pic)));
            ...
            $("<div></div>").addClass("comment-info").append(headTd).append(head).appendTo(".comment-list")
        });
    };
    ...
    $("#tianchuan_btn").click(function () {
        window.location.href = "${pageContext.request.contextPath}/animal/service.jsp";
    });
