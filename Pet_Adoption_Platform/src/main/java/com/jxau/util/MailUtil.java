...
/**
    ...
    public static void sendMail(String to,int state) throws MessagingException {
        ...
        // 设置邮件服务器
        properties.setProperty("mail.smtp.host", "smtp.foxmail.com");
        // 打开认证7
        properties.setProperty("mail.smtp.auth", "true");
        Session session = Session.getInstance(properties, new Authenticator() {
            @Override
            protected PasswordAuthentication getPasswordAuthentication() {
                return new PasswordAuthentication("l1u6@foxmail.com", "gkjkaqkfkfuugaej");
            }
        });
        String word=null;
        if(state==1){
        ...
        //2.1 设置发件人
        message.setFrom(new InternetAddress("l1u6@foxmail.com"));
        //2.2设置收件人
