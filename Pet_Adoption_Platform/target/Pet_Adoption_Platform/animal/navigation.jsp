...
<div class="head">
    ...
    <div class="col-lg-2" style="text-align: left">
        <img class="logo-img center-block" src="${pageContext.request.contextPath}/images/logo.jpg" alt=""
    ...
    <div class="col-lg-6" style=" padding: 10px;text-align: left ;font-size: 18px;">
        ...
        <select language=javascript onchange="location.href=this.value" class="select">
            ...
            <option value="${pageContext.request.contextPath}/animal/teamBlog.jsp">团队博客</option>
            <option value="${pageContext.request.contextPath}/animal/team.jsp">团队展示</option>
        </select>
    </div>
