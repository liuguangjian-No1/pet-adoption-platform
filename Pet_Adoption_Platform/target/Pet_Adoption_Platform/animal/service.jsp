...
<div class="container">
   ...
   <%-- <div class="w3l-img-side">
        <img src="../images/cat1_1.jpg" alt=""/>
    </div>
    <div class="w3l-img-side w3l-img-side2">
        <img src="../images/cat1_2.jpg" alt=""/>
    </div>--%>
</div>
<div class="row">
    <!-- 分页条信息 -->
...
<script type="text/javascript">
    ...
    function build_pets_table(result) {
        ...
        $.each(pets, function (index, pet) {
            ...
            var imgTd = $("<div></div>").addClass("img").append($("<img/>").addClass("img-responsive").attr("src", "/pic/" + spilt(pet.pic)).attr("pet-id", pet.id));
